...
disp('2st scenario')
for j=-10:0.1:10
QY(i)=integral(@(x)pdf('InverseGaussian',x,mu/3,lambda/9).*pdf('InverseGaussian',x+j,mu/3,lambda/9),0,1000);
i=i+1;
end
...
for value = -10:0.1:0
    ...
    Q11(ind)=sum(Q10(Xa).*QY(Ya));
    ind=ind+1;
    clear Xa
    clear Ya
end
size(Q11)
Q11= 0.1*[Q11 fliplr(Q11(1:100))];
trapz(Q11)

% reference Mackey p 159
EntC1=0;
for i=1:100
EntC1=EntC1-0.1*Pa2(i)*0.1*sum(Q11(i:100+i).*log2(Q11(i:100+i)));
end
EntC1
